...
domain_b = 'rgb'
model = dict(
    generator=dict(freeze_flow=False, freeze_linear=True, use_flow=True),
...
lr_config = dict(
    policy='Linear', by_epoch=False, target_lr=0, start=3000, interval=400)
...
total_iters = 5000
workflow = [('train', 1)]
exp_name = 'ganISP_cityscapes_rgb2iphone_raw_freeze_linear'
