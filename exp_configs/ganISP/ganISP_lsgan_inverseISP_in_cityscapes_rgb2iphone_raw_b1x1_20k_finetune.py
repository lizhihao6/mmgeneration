...
domain_b = 'rgb'
model = dict(
    pretrained='work_dirs/experiments/ganISP_cityscapes_rgb2iphone_raw_without_identity/ckpt/ganISP_cityscapes_rgb2iphone_raw_without_identity/latest.pth',
    generator=dict(
        pretrain=False),
...
optimizer = dict(
    generator=dict(type='Adam', lr=5e-5),
...
total_iters = 20000
workflow = [('train', 1)]
exp_name = 'ganISP_cityscapes_rgb2iphone_raw_without_identity_finetune'
